package im.dangmoo.benefit.data.entity.promotion.policy;
...
public class PromotionPolicyDocument {
    ...
    private PromotionPolicyDocument() {
    }
    ...
    public static PromotionPolicyDocument create(
        final String key,
        ...
        final PromotionPolicyDocument policy = new PromotionPolicyDocument();
    ...
    public PromotionPolicyDocument update(
        final String thumbnailImageUrl,
        final String title,
        final String description,
        final Instant startAt,
    ...
    public PromotionPolicyDocument changeStatus(final PromotionPolicyStatus status, final String updatedBy) {
