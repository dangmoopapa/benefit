...
public class PromotionBannerDocument {
    ...
    private PromotionBannerDocument() {
    }
    ...
    public static PromotionBannerDocument create(
        final String key,
        final String name,
        ...
        final PromotionBannerDocument banner = new PromotionBannerDocument();
    ...
    public PromotionBannerDocument update(
        final String name,
        final List<PromotionBannerItem> items,
    ...
    public PromotionBannerDocument changeStatus(final PromotionBannerStatus status, final String updatedBy) {
