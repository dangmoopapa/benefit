package im.dangmoo.benefit.data.entity.coupon.code;
...
public class CouponCodeDocument {
    ...
    public static CouponCodeDocument create(
        ...
        final CouponCodeDocument entity = new CouponCodeDocument();
