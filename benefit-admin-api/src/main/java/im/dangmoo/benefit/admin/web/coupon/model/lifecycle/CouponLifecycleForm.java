...
import im.dangmoo.benefit.domain.coupon.data.policy.lifecycle.CouponLifecycleCondition;
import im.dangmoo.benefit.domain.coupon.data.policy.lifecycle.CouponOnOrderCancel;
import im.dangmoo.benefit.domain.coupon.data.policy.lifecycle.CouponOnPartialCancel;
import im.dangmoo.benefit.domain.coupon.data.policy.lifecycle.CouponOnRefund;
