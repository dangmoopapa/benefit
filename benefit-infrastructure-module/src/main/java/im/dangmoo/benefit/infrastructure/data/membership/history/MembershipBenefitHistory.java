...
public class MembershipBenefitHistory {
    ...
    private MembershipBenefitHistory() {
    }
    ...
    public static MembershipBenefitHistory apply(
        final String userId,
        ...
        final MembershipBenefitHistory history = new MembershipBenefitHistory();
