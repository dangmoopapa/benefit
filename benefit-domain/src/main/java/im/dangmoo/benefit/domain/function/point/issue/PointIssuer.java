...
public class PointIssuer {
    ...
    public PointIssue issue(
        ...
        pointBalanceRepository.issue(userId, point, expiresAt, actorId, now);
    ...
    public PointRevoke revoke(
        ...
        try {
            pointBalanceRepository.revoke(issued.getUserId(), issued.getPoint(), issued.getExpiresAt(), actorId, now);
