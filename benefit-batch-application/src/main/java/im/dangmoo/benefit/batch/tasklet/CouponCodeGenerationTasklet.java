...
public class CouponCodeGenerationTasklet implements Tasklet, StepExecutionListener {
    ...
    public RepeatStatus execute(
        ...
        final CouponPolicyDocument policy = couponPolicyMongoRepository.findByKey(parameter.policyKey())
    ...
    private void insertRandomCode(final CouponPolicyDocument policy) {
