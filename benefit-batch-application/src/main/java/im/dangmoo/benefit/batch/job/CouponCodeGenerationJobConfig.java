package im.dangmoo.benefit.batch.job;

import im.dangmoo.benefit.batch.BatchJobName;
import im.dangmoo.benefit.batch.tasklet.CouponCodeGenerationTasklet;
...
public class CouponCodeGenerationJobConfig {
    ...
    Job couponCodeGenerationJob(
        ...
        return new JobBuilder(BatchJobName.COUPON_CODE_GENERATION.name(), jobRepository)
